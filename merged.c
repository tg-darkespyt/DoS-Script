int fcn.00000cb8 (int x0, int x1) {
    loc_0x00000cb8:
        // CALL XREF from fcn.00001038 @ 0x109c(x)
        [sp - 0x40]! = x28
        [var_0hx10] = (x22, 2)
        [var_0hx20] = (x20, 2)
        [var_0hx30] = (x29, 2)
        ...
        w1 = 0x20
        [sp] = 0
        sym.imp.snprintf () // int snprintf("", 0x00000040, "/proc/%d/maps", 0)
        // XREFS(30)
        x1 = 0x1000
        x1 = x1 + 0xd19 // const char *mode // "rt"
        x0 = x29 - 0x58 // const char *filename
        sym.imp.fopen () // file*fopen("", "rt")
        x20 = x0
        if (!x0) goto 0xd6c // unlikely
        goto loc_0x00000d18;
    loc_0x00000d6c:
        // CODE XREF from fcn.00000cb8 @ 0xd14(x)
        x8 = [x21 + 0x28] // "P1" // elf_shdr
        x9 = [x29 -0x38]
        (a, b) = compare (x8, x9)
        ...
        goto loc_0x00000d7c;
    loc_0x00000d94:
        // CODE XREF from fcn.00000cb8 @ 0xd78(x)
        sym.imp.__stack_chk_fail () // fcn.00000d98 // void __stack_chk_fail(void)
        return x0;
    loc_0x00000d1c: // orphan
         // DATA XREFS from fcn.00000cb8 @ 0xd48(x), 0xd50(r)
         x0 = sp + 8              // char *s
         w1 = 0x400 // DATA XREF from fcn.00000d98 @ 0xdc8(r)
         x2 = x20                 // FILE *stream
         sym.imp.fgets () // char *fgets("", 0x00000000, 0)
         if (!x0) 
         goto loc_0x00000d60
    loc_0x00000d30: // orphan
         w8 = (byte) [x19] // DATA XREF from fcn.00000d98 @ 0xe50(r)
         x1 = x22
         if (w8 == 0) 
         goto loc_0x00000d40
    ...
    loc_0x00000d40: // orphan
         // CODE XREF from fcn.00000cb8 @ 0xd38(x)
    ...
    loc_0x00000d60: // orphan
         // CODE XREF from fcn.00000cb8 @ 0xd2c(x)
         x0 = x20                 // FILE *stream
...
int entry0 (int x0, int x1) {
    loc_0x00000c40:
        x0 = sp       // [12] -r-x section size 4248 named .text
        goto 0xc60
        
    loc_0x00000c60:
        // CODE XREF from entry0 @ 0xc44(x)
        x2 = 0x12000
        x6 = 0x12000
        x5 = 0x12000
        x4 = 0x12000
        ...
        x2 = [x2 + 0xfe0] // [0x1038:4]=0xd10243ff // fcn.00001038
        [x29 + 0x18] = x6
        [x29 + 0x20] = x5
        [x29 + 0x28] = x4
        sym.imp.__libc_init ()
